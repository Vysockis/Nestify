...
urlpatterns = [
    ...
    path('api/operations/<int:operation_id>/edit/', views.edit_operation, name="finance-edit-operation"),
    path('api/operation-items/<int:item_id>/edit/', views.edit_operation_item, name="finance-edit-operation-item"),
]
