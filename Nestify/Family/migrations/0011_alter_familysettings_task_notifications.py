...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('all', 'Visi šeimos nariai'), ('parents', 'Tik tėvai'), ('admin', 'Tik administratorius')], default='all', max_length=20, verbose_name='Užduočių pranešimai'),
        ),
    ]
